        ...
        <div class="row">
            <div class="col-md-7">
                <div class="">
                    ...
                    <p class="animated fadeInLeft" style="animation-delay: .1s;">There is simply no better way to
        ...
        <div class="row">
            <div class="col-md-4 wow animated fadeInDown">
                <div class="image-dv text-center">
                    ...
                    <h4 class="bottom-subtitle">Food</h4>
            ...
            <div class="col-md-4 wow animated fadeInDown" style="animation-delay: .4s;">
                <div class="image-dv text-center">
                    ...
                    <h4 class="bottom-subtitle">Toys</h4>
            ...
            <div class="col-md-4 wow animated fadeInDown" style="animation-delay: .8s;">
                <div class="image-dv text-center">
                    ...
                    <h4 class="bottom-subtitle">Location</h4>
